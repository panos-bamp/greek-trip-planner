...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[#FAF6F3]">
      ...
      {/* ═══════════════════════════════════════════
          AUTHOR CARD + AFFILIATE DISCLAIMER — same row
          ───────────────────────────────────────────
          Mobile (<768px): stacked. Author card → disclaimer.
        ...
        <div className="flex flex-col md:flex-row md:items-stretch gap-3">
          ...
          <aside className="md:w-[260px] md:flex-shrink-0 bg-white rounded-2xl border border-[#E6DAD1]/60 p-4 flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="text-sm font-semibold text-[#180204] font-sans leading-tight">
                Panos
              </div>
              <div className="text-xs text-[#180204]/55 font-sans leading-snug mt-0.5">
                Founder · Greek Trip Planner
              </div>
            </div>
          </aside>

          {/* ─── Affiliate disclaimer (RIGHT desktop / BELOW mobile) ─── */}
