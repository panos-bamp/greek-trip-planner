  ...
  return (
    <>
      {/* Breadcrumb — carries the hub↔spoke hierarchy since the URL itself
          ...
          pt-[72px] clears the 64px fixed nav with 8px of visible breathing room. */}
      <div className="max-w-[1120px] mx-auto px-5 sm:px-8 pt-[72px] pb-[18px] font-mono text-[11px] text-[#999]">
